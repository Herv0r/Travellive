            ...
            <div className="sm:col-span-3">
              ...
              <div className="mt-2">
                <select
                  ...
                  className="block w-full rounded-md border-0 pl-1 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus-within:ring-secondary3 sm:max-w-xs sm:text-sm sm:leading-6"
                >
                ...
                <div className="relative flex gap-x-3">
                  <div className="flex h-6 items-center">
                    <input
                      ...
                      name="comments"
                      type="checkbox"
                      className="h-4 w-4 rounded border-gray-300 text-secoondary6 focus-within:ring-secondary3"
                    />
                  </div>
                ...
                <div className="relative flex gap-x-3">
                  <div className="flex h-6 items-center">
                    <input
                      ...
                      name="candidates"
                      type="checkbox"
                      className="h-4 w-4 rounded border-gray-300 text-secondary6 focus-within:ring-secondary3"
                    />
                  </div>
                  <div className="text-sm leading-6">
                    <label
                ...
                <div className="relative flex gap-x-3">
                  <div className="flex h-6 items-center">
                    <input
                      ...
                      name="offers"
                      type="checkbox"
                      className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus-within:ring-secondary3"
                    />
                  </div>
                  <div className="text-sm leading-6">
                    <label
