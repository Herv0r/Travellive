          ...
          <div className="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
            {products.map((product) => (
              <a key={product.id} href={product.href} className="group">
                ...
                <h3 className="mt-4 text-md font-medium text-gray-900">{product.name}</h3>
                <p className="text-md font-nunito text-gray-500">{product.description}</p>
                <p className="text-md font-nunito text-gray-500">{product.fecha}</p>
